...
public class Term extends BaseActivity implements UpdateCallback {
    ...
    private static final String ACTION_PATH_BROADCAST = "jackpal.androidterm.broadcast" +
            ".APPEND_TO_PATH";
    private static final String ACTION_PATH_PREPEND_BROADCAST = "jackpal.androidterm.broadcast" +
            ".PREPEND_TO_PATH";
    private static final String PERMISSION_PATH_BROADCAST = "jackpal.androidterm.permission" +
            ".APPEND_TO_PATH";
    private static final String PERMISSION_PATH_PREPEND_BROADCAST = "jackpal.androidterm" +
            ".permission.PREPEND_TO_PATH";
    ...
    private class WindowListActionBarAdapter extends WindowListAdapter implements UpdateCallback {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            String title = getSessionTitle(position, getString(R.string.window_title, position +
                    1));
            label.setText(title);
    ...
    private ActionBarCompat.OnNavigationListener mWinListItemSelected = new ActionBarCompat
    ...
    private class EmulatorViewGestureListener extends SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            if (link != null)
                ...
                doUIToggle((int) e.getX(), (int) e.getY(), view.getVisibleWidth(), view
                        .getVisibleHeight());
            return true;
        }
    ...
    private View.OnKeyListener mKeyListener = new View.OnKeyListener() {
        ...
        private boolean backkeyInterceptor(int keyCode, KeyEvent event) {
            if (keyCode == KeyEvent.KEYCODE_BACK && mActionBarMode == TermSettings
                    .ACTION_BAR_MODE_HIDES && mActionBar.isShowing()) {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPendingPathBroadcasts++;
        sendOrderedBroadcast(broadcast, PERMISSION_PATH_BROADCAST, mPathReceiver, null,
                RESULT_OK, null, null);

        broadcast = new Intent(broadcast);
        broadcast.setAction(ACTION_PATH_PREPEND_BROADCAST);
        mPendingPathBroadcasts++;
        sendOrderedBroadcast(broadcast, PERMISSION_PATH_PREPEND_BROADCAST, mPathReceiver, null,
                RESULT_OK, null, null);
    ...
    protected static TermSession createTermSession(Context context, TermSettings settings, String
            initialCommand) {
    ...
    private void updatePrefs() {
...

        {
            ...
            if (desiredFlag != (params.flags & FULLSCREEN) || (AndroidCompat.SDK >= 11 &&
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_new_window), MenuItemCompat
                .SHOW_AS_ACTION_ALWAYS);
        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_close_window), MenuItemCompat
                .SHOW_AS_ACTION_IF_ROOM);
        //        MenuItemCompat.setShowAsAction(menu.findItem(R.id.menu_float_window),
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_preferences) {
            ...
            doResetTerminal();
            Toast toast = Toast.makeText(this, R.string.reset_toast_notification, Toast
                    .LENGTH_LONG);
            ...
            //            LinearLayout floatLayout = (LinearLayout) LayoutInflater.from
            // (getApplication()).inflate(R.layout.float_layout, null);
            finish();
