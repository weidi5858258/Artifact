...
import com.weidi.artifact.ui.internal.EmptyViewMethodAccessor;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> 
	...
	public PullToRefreshAdapterViewBase(Context context) {
		super(context);
		refreshableView.setOnScrollListener(this);//T refreshableView;来自父类
	}
...
//	public interface ContextMenu extends Menu{//系统的上下文菜单
...
//	}
		...
		mTopImageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (refreshableView instanceof ListView ) {
					...
					((GridView)refreshableView).setSelection(0);//Selection:n. 选择，挑选；选集；精选品
				}
			}
		});
	}
	...
	protected boolean isReadyForPullDown() {//往下拉
		return isFirstItemVisible();
	}

	protected boolean isReadyForPullUp() {//往上拉
