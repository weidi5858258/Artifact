...
public interface IMountService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMountService {
        private static class Proxy implements IMountService {
            ...
            public int createSecureContainer(String id, int sizeMb, String fstype, String key,
                                             int ownerUid, boolean external) throws
                    RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                int _result;
            ...
            public String getSecureContainerFilesystemPath(String id) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken(DESCRIPTOR);
                    _data.writeString(id);
                    mRemote.transact(Stub.TRANSACTION_getSecureContainerFilesystemPath, _data,
                            _reply, 0);
                    _reply.readException();
                    _result = _reply.readString();
                } finally {
            ...
            public int fixPermissionsSecureContainer(String id, int gid, String filename)
                ...
                try {
                    ...
                    mRemote.transact(Stub.TRANSACTION_fixPermissionsSecureContainer, _data,
                            _reply, 0);
                    _reply.readException();
                    _result = _reply.readInt();
                } finally {
        ...
        static final int TRANSACTION_isExternalStorageEmulated = IBinder.FIRST_CALL_TRANSACTION +
                25;
        ...
        static final int TRANSACTION_getSecureContainerFilesystemPath = IBinder
                .FIRST_CALL_TRANSACTION + 30;
        ...
        static final int TRANSACTION_fixPermissionsSecureContainer = IBinder
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply,
            ...
            switch (code) {
                ...
                case TRANSACTION_getVolumeList: {
                    ...
                    reply.writeNoException();
                    reply.writeTypedArray(result, android.os.Parcelable
     ...
     * @param force            whether or not to forcefully unmount it (e.g. even if programs are
     *                         using this
     *                         data currently)
