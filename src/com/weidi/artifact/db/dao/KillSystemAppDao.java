...
public class KillSystemAppDao {
	private MyInfosSQLiteOpenHelper help;
	private SQLiteDatabase db;
	private Context context;
	private Intent intent;
	
	public KillSystemAppDao(Context context){
		help = new MyInfosSQLiteOpenHelper(context);
		this.context = context;
	}
	
	public void add(String packageName){
		String sql = "insert into systemapp (packagename) values (?);";
	...
	public void delete(String packageName){
		String sql = "delete from systemapp where packagename=?;";
		db = help.getWritableDatabase();
		db.execSQL(sql,new String[]{packageName});
		db.close();
		intent = new Intent();
...
//	}
	...
	public List<String> querySystemApp(){
		List<String> list = new ArrayList<String>();
		String sql = "select packagename from systemapp;";
		db = help.getReadableDatabase();
		Cursor cursor = db.rawQuery(sql, null);
